...
export const Upload = () => {
  ...
  async function onSubmit() {
    const response = await axios.post(
      `http://localhost:${BACKEND_URL}/user/task`,
      {
  ...
  return (
    <div className="flex justify-center text-white">
      <div className="max-w-screen-lg w-full">
        ...
        <label className="pl-4 block mt-2 text-md font-medium text-white">
          Task details
        </label>
        ...
        <div className="flex gap-[2vw] items-center mt-[2vw]">
          <label className="pl-4 block text-md font-medium text-white">
